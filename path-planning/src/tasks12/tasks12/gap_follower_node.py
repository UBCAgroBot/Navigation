...
class gap_follower_node(Node):
    ...
    def __init__(self):
        ...
        self.car_width = 0.3                # meters        (width of the car)
        self.Kp = 0.56                      # dimensionless (porportional control)
    ...
    def disparity_extender(self, scan_fixed, scan):
        ...
        for i in range(1, len(scan_fixed) - 1):
            ...
            if prev_dist == 0 or curr_dist == 0 or next_dist == 0:
                continue
    ...
    def find_center_largest_gap(self, scan_fixed, scan):
        ...
        i_min = 200     # Min angle considered = -85deg in Lidar
        i_max = 880     # Max angle considered = +85deg in Lidar
