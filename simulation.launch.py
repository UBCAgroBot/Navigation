...
def generate_launch_description() -> LaunchDescription:
    ...
    sim_time_bridge = Node(
        ...
        arguments=["/clock@rosgraph_msgs/msg/Clock[gz.msgs.Clock", "/imu@sensor_msgs/msg/Imu@gz.msgs.IMU", "/lidar@sensor_msgs/msg/LaserScan[ignition.msgs.LaserScan", "/tf@tf2_msgs/msg/TFMessage[ignition.msgs.Pose_V", 
            "/odom@nav_msgs/msg/Odometry[ignition.msgs.Odometry", "/cmd_vel@geometry_msgs/msg/Twist@gz.msgs.Twist"],
    )
